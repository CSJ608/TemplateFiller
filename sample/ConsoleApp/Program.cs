...
var data = new Dictionary<string, object>()
{
    ...
    ["Persons"] = new[]
    {
        new { Name = "张三", Age = 18, Sex = "男", WorkNo = "20001",  Description = "123"},
        new { Name = "张1", Age = 20, Sex = "女", WorkNo = "30001",  Description = ""},
        new { Name = "张2", Age = 30, Sex = "男", WorkNo = "40001",  Description = ""},
        new { Name = "张3", Age = 40, Sex = "女", WorkNo = "50001",  Description = ""},
        new { Name = "张4", Age = 50, Sex = "男", WorkNo = "60001",  Description = ""},
    }
};
